...
![Failed login limit](Writeup_elements/01.rate_limit.png)
...
![Bypassing the source address restriction](Writeup_elements/02.Bypass%20source%20address%20restrictions.png)
...
![Timing difference 1](Writeup_elements/03.timing-comparison1.png)
![Timing difference 2](Writeup_elements/03.timing-comparison2.png)
![Timing difference 3](Writeup_elements/03.timing-comparison3.png)
![Timing difference 4](Writeup_elements/03.timing-comparison4.png)

### 4. Enumerating the Valid Username
...
Therefore, the valid username was:

```text
Valid username: apple
```

![Username enumeration result](Writeup_elements/04.username-enumeration.png)

### 5. Finding the Correct Password

After identifying the valid username, I fixed the username as `apple` and brute-forced only the password parameter.
...
![Correct password identification result](Writeup_elements/05.password-result.png)
